...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "breakup_choose": "请选择要离婚的人：",
        "breakup_all": "全部离婚",
        "breakup_choose_hint": "请在60秒内回复编号，或回复“全部离婚”；回复“取消”放弃。强娶关系不可解除，全部离婚包含强娶关系时不会执行。",
        "breakup_changed": "老婆关系已发生变化，请重新发送“离婚”选择。",
        "breakup_cancelled": "已取消离婚。",
    ...
    "en-US": {
        ...
        "breakup_choose": "Choose who to break up with:",
        "breakup_all": "Break up with everyone",
        "breakup_choose_hint": "Reply with a number or “all” within 60 seconds; reply “cancel” to cancel. Forced marriages cannot end; selecting all fails if any are present.",
        "breakup_changed": "Your relationships changed. Run /breakup again to choose.",
        "breakup_cancelled": "Breakup cancelled.",
    ...
    "ja-JP": {
        ...
        "breakup_choose": "別れる相手を選んでください：",
        "breakup_all": "全員と別れる",
        "breakup_choose_hint": "60秒以内に番号または「all」を返信してください。「cancel」で取り消します。強引な結婚は解除できず、含まれる場合は全員との別れも実行されません。",
        "breakup_changed": "関係が変更されました。/breakup で選び直してください。",
        "breakup_cancelled": "キャンセルしました。",
